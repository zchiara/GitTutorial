...
Questi sistemi, come Subversion o Perforce, hanno un singolo server che contiene tutte le versioni dei file ed un numero variabile di utenti posso scaricare i file da questo server centrale.
